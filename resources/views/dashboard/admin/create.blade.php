...
<form action="{{route('dashboard.admin.store')}}" method="post" class="ml-3" enctype="multipart/form-data">
    @csrf


    <div class="form-group">
        <x-form.input label="Admin Name" name="name" type="text" />
    </div>
    ...
    <div class="form-group">
        <x-form.input name="type" type="hidden" value="admin" />
    </div>
